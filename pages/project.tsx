...
export default function Project({
  ...
  return (
    <Container
      title="Project - Dalamkotak"
      description="All of my project that i've made"
    >
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          {`All of my projects that I've been made, started when I was still in college until now. Most of them are just fun projects `}
        </p>
...
export function getStaticProps() {
  const posts = allProjects
    .map((post) =>
      pick(post, ['slug', 'title', 'summary', 'publishedAt', 'logo'])
    )
    .sort(
      (a, b) =>
